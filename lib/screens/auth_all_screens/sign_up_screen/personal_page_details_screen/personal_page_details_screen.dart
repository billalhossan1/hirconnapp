                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text:
                              'Used to show people near you. We use this information to personalize your experience. Learn more in our ',
                        ),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        showStar
            ? CommonText(text: '*', textColor: Colors.red, fontSize: 18)
            : SizedBox.shrink(),
      ],
    );
  }
